...
const Corinth = () => {
    return ( 
      ...
      <h1 style={{ fontFamily: 'Parisienne', color: 'white', paddingBottom: '20px'}}><img src={amph} style={{padding:'40px', width:'10%'}}/>Coins of Corinth<img src={amph} style={{padding:'40px', width:'10%'}}/></h1>
